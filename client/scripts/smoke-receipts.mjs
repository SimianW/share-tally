...
try {
  ...
  assert.deepEqual(errors, []);
  console.log(
    "Receipt browser smoke passed: private draft recovery, saved automatic scans, processing draft status and read-only editors, live ready banners and dismissals, desktop/mobile fallback tax filters and confirmations, second-tab completion, confidence badges, filter counts, confirmation and reload on desktop/mobile, compact rows, editor navigation, live reconciliation and summary edits, signed-cent allocation, photo zoom, exact thirds, claims, frozen-rate corrections and manual overrides, taxability and tax-inclusive previews, reservations, completion and adjustment.",
  );
} catch (error) {
