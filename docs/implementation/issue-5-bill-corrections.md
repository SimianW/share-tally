...
Any initiator edit, including a descriptive edit, clears all confirmations. Retained participants keep their amounts. Changing an existing share also clears everyone's confirmation, including the sender's; the sender confirms the saved amount separately. First submissions and unchanged confirmations preserve other confirmations and the bill revision.
